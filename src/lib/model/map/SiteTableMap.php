...
class SiteTableMap extends TableMap
{
	 ...
	 */
	const CLASS_NAME = 'lib.model.map.SiteTableMap';
	...
	{
		$this->addRelation('Evaluation', 'Evaluation', RelationMap::ONE_TO_MANY, array('id' => 'site_id', ), 'CASCADE', null, 'Evaluations');
	} // buildRelations()
