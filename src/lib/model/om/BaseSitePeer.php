...
abstract class BaseSitePeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Url', 'Description', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'url', 'description', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::URL, self::DESCRIPTION, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'URL', 'DESCRIPTION', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'url', 'description', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Url' => 1, 'Description' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'url' => 1, 'description' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::URL => 1, self::DESCRIPTION => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'URL' => 1, 'DESCRIPTION' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'url' => 1, 'description' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(SitePeer::URL);
			$criteria->addSelectColumn(SitePeer::DESCRIPTION);
		} else {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseSitePeer', $criteria, $con);
		}
	...
	{
		return $withPrefix ? SitePeer::CLASS_DEFAULT : SitePeer::OM_CLASS;
	}
	...
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += SitePeer::doOnDeleteCascade(new Criteria(SitePeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += SitePeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = SitePeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {
			...
			$criteria->add(EvaluationPeer::SITE_ID, $obj->getId());
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseSitePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
